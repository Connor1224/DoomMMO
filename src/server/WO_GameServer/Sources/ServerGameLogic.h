...
#define IMPL_PACKET_FUNC(CLASS, XX) \
	...
	DEFINE_PACKET_FUNC(PKT_C2S_Explosion_Damage);
	...
	DEFINE_PACKET_FUNC(PKT_S2C_Flashlight);
	DEFINE_PACKET_FUNC(PKT_S2C_Threat);
	...
	DEFINE_PACKET_FUNC(PKT_S2C_SendGroupIDChange);
