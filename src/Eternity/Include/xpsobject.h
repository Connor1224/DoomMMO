...
*/
	...
	pVB = new r3dVertexBuffer( NumVertices, sizeof(vert_s), 0, (dwFlags & D3DUSAGE_DYNAMIC)?true:false );
	pIB = new r3dIndexBuffer( NumIndices, (dwFlags & D3DUSAGE_DYNAMIC)?true:false, sizeof(DWORD) );
...
/*	hr = r3dRenderer->pd3ddev->CreateVertexBuffer(
	...
	pVB = new r3dVertexBuffer( VertexSize, sizeof(vert_s), 0, (dwFlags & D3DUSAGE_DYNAMIC)?true:false );
	pIB = new r3dIndexBuffer( IndexSize, (dwFlags & D3DUSAGE_DYNAMIC)?true:false, sizeof(DWORD) );
...
/*	hr = r3dRenderer->pd3ddev->CreateVertexBuffer(
	...
	pVB = new r3dVertexBuffer( VertexSize, sizeof(vert_s), VertFVF, dwFlags & D3DUSAGE_DYNAMIC );
	pIB = new r3dIndexBuffer( IndexSize, dwFlags & D3DUSAGE_DYNAMIC, sizeof(DWORD) );
