...
int r3dToggleScreenShot()
{
	...
	{
		char DFileName[128];
		sprintf(DFileName, "ScreenShot\\Screen_%02d%02d%04d_%02d%02d%02d_depth.jpg", curdate.tm_mday, curdate.tm_mon, 1900+curdate.tm_year, curdate.tm_hour, curdate.tm_min, curdate.tm_sec);
