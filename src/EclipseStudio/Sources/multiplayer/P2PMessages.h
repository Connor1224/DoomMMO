...
#define P2PNET_VERSION	  (0x0000042A + GBWEAPINFO_VERSION + GBGAMEINFO_VERSION + GAMEPLAYPARAM_VERSION) // Allright Net
...
struct PKT_C2C_Aura_s : public DefaultPacketMixin<PKT_C2C_Aura>
{
};
...
struct PKT_S2C_Threat_s : public DefaultPacketMixin<PKT_S2C_Threat>
{
	int	value;
};
...
struct  PKT_S2C_SendGroupIDChange_s : public DefaultPacketMixin<PKT_S2C_SendGroupIDChange>
{
DWORD		FromCustomerID;
	char		intogamertag[128];
};
