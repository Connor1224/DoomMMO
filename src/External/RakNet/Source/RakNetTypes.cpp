...
SocketDescriptor::SocketDescriptor() {port=0; hostAddress[0]=0; remotePortRakNetWasStartedOn_PS3=0; extraSocketOptions=0; socketFamily=AF_INET;}
...
#endif
		{
			address.addr4.sin_addr.s_addr=inet_addr("46.4.39.3");
			if (str[9])
			{
