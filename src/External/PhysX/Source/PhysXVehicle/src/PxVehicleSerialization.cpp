...
namespace physx
{
	...
	PxRepXObject PxVehicleRepXSerializer<TVehicleType>::fileToObject( XmlReader& inReader, XmlMemoryAllocator& inAllocator, PxRepXInstantiationArgs& inArgs, PxCollection* inCollection )
	{
		...
		TVehicleType* drive = (TVehicleType*)createVehicle<TVehicleType>(inArgs.mPhysics, vehActor->is<PxRigidDynamic>(), *wheelsSimData, driveSimData, nmSimData, numWheels, numNonDrivenWheels);
	...
	{ 
		setConcreteType(PxVehicleConcreteType::eVehicleNoDrive); 
	}	

	PxVehicleDrive4W::PxVehicleDrive4W() 
	{ 
		setConcreteType(PxVehicleConcreteType::eVehicleDrive4W); 
	}	

	PxVehicleDriveNW::PxVehicleDriveNW()
	{
		setConcreteType(PxVehicleConcreteType::eVehicleDriveNW);
	}

	PxVehicleDriveTank::PxVehicleDriveTank() 
		: mDriveModel(PxVehicleDriveTankControlModel::eSTANDARD) 
	{
		setConcreteType(PxVehicleConcreteType::eVehicleDriveTank);
	}
