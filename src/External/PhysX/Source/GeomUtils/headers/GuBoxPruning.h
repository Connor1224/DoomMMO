...
namespace Gu
{
	...
	PX_PHYSX_COMMON_API bool BruteForceCompleteBoxTest(const PxBounds3* bounds, PxU32 nb, Ps::Array<PxU32>& pairs, const Gu::Axes& axes);
	PX_PHYSX_COMMON_API bool BruteForceBipartiteBoxTest(const PxBounds3* bounds0, PxU32 nb0, const PxBounds3* bounds1, PxU32 nb1, Ps::Array<PxU32>& pairs, const Gu::Axes& axes);
