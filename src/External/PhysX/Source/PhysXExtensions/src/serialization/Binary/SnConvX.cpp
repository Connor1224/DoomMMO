...
Sn::ConvX::ConvX(physx::PxErrorCallback* error, PxSerializationRegistry& sr) :
	mMetaData_Src		(NULL),
	mMetaData_Dst		(NULL),
	mOutStream			(NULL),
	mMustFlip			(false),
...
bool Sn::ConvX::convert(PxInputStream& srcStream, PxU32 srcSize, PxOutputStream& targetStream)
{
	...
	{
		if(mErrorCallback)
			mErrorCallback->reportError(PxErrorCode::eINVALID_OPERATION, "ConvX error: meta-data not defined. Call 'setMetaData' first.\n", __FILE__, __LINE__);
		return false;
	}
