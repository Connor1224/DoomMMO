...
namespace physx { 
	...
	public:
		...
		virtual void destroy() { mAllocator.deallocate(this); }
		virtual const char* getTypeName() { return PxTypeInfo<TLiveType>::name(); }
		
		virtual void objectToFile( PxRepXObject inLiveObject, PxCollection* inCollection, XmlWriter& inWriter, MemoryBuffer& inTempBuffer, PxRepXInstantiationArgs& inArgs )
		{
