...
CLauncherConfig::CLauncherConfig()
{
	...
	serialBuyURL = "http://localhost/";
	serialExpiredBuyURL = "http://localhost/";

	accountForgotPasswordURL = "http://localhost/";

	myAccountURL = "http://localhost/";
	forumsURL = "http://localhost/";
	supportURL = "http://localhost/";
	youtubeURL = "http://localhost/";
	facebookURL = "http://localhost/";
